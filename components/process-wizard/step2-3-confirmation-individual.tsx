...
import { User, Building, FileText, Clock, Users } from "lucide-react"
  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-sm text-muted-foreground">{t("confirmationIndividualMultipleDescription")}</p>
      </div>
          ...
          <CardContent className="space-y-3">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex flex-col sm:flex-row sm:justify-between gap-1">
                ...
                <span className="text-sm font-medium truncate">{companyApplicant?.name || "-"}</span>
              </div>
              <div className="flex flex-col sm:flex-row sm:justify-between gap-1">
        ...
        <CardContent className="pt-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">{t("individualMultipleStatusDescription")}</p>
            </div>
