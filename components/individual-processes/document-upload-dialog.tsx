      ...
      <DialogContent className="sm:max-w-[500px] max-h-[85vh] overflow-y-auto">
        ...
        <div className="space-y-4 py-4">
          ...
          <DocumentWaitingStartDateField
            ...
            id="document-upload-waiting-start-date"
          />
          ...
          {conditions && conditions.length > 0 && (
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-2 rounded-lg border border-blue-200 bg-blue-50 dark:border-blue-800 dark:bg-blue-950 p-3">
                <Checkbox
                  id="bypass-conditions-upload"
                  checked={bypassConditions}
                  onCheckedChange={(checked) => setBypassConditions(checked === true)}
                  disabled={isUploading}
                />
                <div className="grid gap-0.5 leading-none">
                  <label htmlFor="bypass-conditions-upload" className="text-sm font-medium cursor-pointer">
                    {t("bypassConditions")}
                  </label>
                  <p className="text-xs text-muted-foreground">
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={
              (!selectedFile && (!existingDocumentId || !versionNotes.trim())) ||
              isUploading ||
