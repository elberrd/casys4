                    ...
                    <div className="flex w-full flex-1 items-start gap-3 sm:items-center">
                        ...
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <span className="shrink-0" onClick={(e) => e.stopPropagation()}>
                              {doc.documentTypeId ? (
                                <FileType className="h-5 w-5 text-sky-500" />
                              ) : (
                          ...
                          <TooltipContent side="top">
                            {doc.documentTypeId ? tDoc("uploadWithType") : tDoc("looseDocument")}
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
                      <div className="flex-1 min-w-0">
                        ...
                        {doc.previousRejectionReason && (
                          <p className="mt-1 text-xs text-muted-foreground [overflow-wrap:anywhere] whitespace-pre-wrap">
                            {doc.previousRejectionReason}
                          </p>
                        )}
                        {doc.versionNotes && (
