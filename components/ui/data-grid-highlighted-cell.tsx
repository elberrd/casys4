...
export function DataGridHighlightedCell({
  ...
  // Use explicit search term if provided, otherwise get from table state directly
  const searchTerm = explicitSearchTerm ?? (context?.table?.getState()?.globalFilter as string) ?? ""
