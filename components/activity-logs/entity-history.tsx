...
const FIELD_LABELS: Record<string, Record<string, string>> = {
  pt: {
    ...
    userApplicantCompanyId: "Empresa do solicitante",
    personId: "Pessoa",
  ...
  en: {
    ...
    userApplicantId: "Requester",
    userApplicantCompanyId: "Requester company",
    personId: "Person",
      ...
      items.push({
        ...
        content: (
          <div className="flex items-center gap-2 text-xs">
            ...
            <Badge className="text-xs font-normal">{details.statusTo}</Badge>
          </div>
        ),
      });
    }
          ...
          content: (
            <div className="space-y-1">
              ...
              {changeEntries.length > 5 && (
                <span className="text-xs text-muted-foreground">
                  +{changeEntries.length - 5}{" "}
                  {locale === "pt" ? "mais alteracoes" : "more changes"}
                </span>
              )}
            </div>
          ),
          ...
          return (
            <div key={log._id} className="relative flex gap-3 group">
              ...
              <div className="flex flex-col items-center">
                <div
                  className={`flex h-8 w-8 items-center justify-center rounded-full shrink-0 ${style.bg} ${style.text}`}
                >
                ...
                <div className="flex items-start justify-between gap-2">
                  <div className="min-w-0 flex-1">
                    {subEntityType && (
                      <div className="flex items-center gap-1 mb-0.5">
                        <span className="text-muted-foreground">
                          {SUB_ENTITY_ICONS[subEntityType]}
                        </span>
                        <span className="text-xs font-medium text-muted-foreground">
                          {t(`subEntityTypes.${subEntityType}`, {
                            defaultValue: subEntityType,
                          })}
                    ...
                    <p className="text-sm">
                      ...
                      <span className="text-muted-foreground">
                        {" "}
                        &middot; {actionLabel.toLowerCase()}
                      </span>
                    </p>
                  ...
                  <Badge
                    variant="outline"
                    className={`text-[10px] shrink-0 ${style.badge}`}
                  >
                    {actionLabel}
                  </Badge>
                </div>
