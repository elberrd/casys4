...
import { PassportViewModal } from "@/components/passports/passport-view-modal"
...
export function PassportsClient() {
  ...
  const [viewingId, setViewingId] = useState<Id<"passports"> | null>(null)
  ...
  const handleView = (id: Id<"passports">) => {
    setViewingId(id)
  }
