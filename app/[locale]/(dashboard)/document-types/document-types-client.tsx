...
import { DocumentTypeViewModal } from "@/components/document-types/document-type-view-modal"
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export function DocumentTypesClient() {
  ...
  const [viewingDocumentType, setViewingDocumentType] = useState<Id<"documentTypes"> | undefined>()
  ...
  const handleView = (id: Id<"documentTypes">) => {
    setViewingDocumentType(id)
  }
  ...
  return (
    <>
      ...
      {viewingDocumentType && (
        <DocumentTypeViewModal
          documentTypeId={viewingDocumentType}
          open={true}
          onOpenChange={(open) => !open && setViewingDocumentType(undefined)}
          onEdit={() => {
            setEditingDocumentType(viewingDocumentType)
