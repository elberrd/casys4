...
export const FIELD_REGISTRY: Record<EntityType, FieldRegistryEntry[]> = {
  person: [
    ...
    { fieldPath: "address", label: "Endereco (legado)", labelEn: "Address (legacy)", fieldType: "text" },
    { fieldPath: "addressStreet", label: "Logradouro", labelEn: "Street", fieldType: "text" },
    { fieldPath: "addressNumber", label: "Numero", labelEn: "Number", fieldType: "text" },
    { fieldPath: "addressComplement", label: "Complemento", labelEn: "Complement", fieldType: "text" },
    { fieldPath: "addressNeighborhood", label: "Bairro", labelEn: "Neighborhood", fieldType: "text" },
